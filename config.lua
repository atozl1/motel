...
Config.HelpTextMessage = "Sol ~INPUT_CELLPHONE_LEFT~ & ~INPUT_CELLPHONE_RIGHT~ Sağ ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_FRONTEND_RDOWN~ Satın alımı onayla Fiyat: ($" .. Config.MotelPrice .. ") ~n~"
Config.HelpTextMessage = Config.HelpTextMessage .. "~INPUT_FRONTEND_CANCEL~ İptal Et ~n~"
